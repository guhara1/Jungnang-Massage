...
content/
  ...
  areas.py          # 지역별: 중랑구 허브 + 대표 동 6개
  stations.py       # 지하철역별: 허브 + 11개 역
...
- 지역은 대표 동 6개만 (면목동·상봉동·중화동·묵동·망우동·신내동) — 숫자 행정동 페이지 없음
...
/                                        메인
/jungnang/                               지역 허브
/jungnang/{dong}-chuljangmassage/        대표 동 (myeonmok, sangbong …)
/jungnang/stations/                      역 허브
/jungnang/{역}-station-chuljangmassage/   지하철역
/themes/{theme}/
/courses/ /reservation/ /guide/ /reviews/ /support/ /support/privacy/ /support/terms/
/magazine/ /magazine/{slug}/  /about/
```
...
3. Google Search Console에 `sitemap.xml` 제출 (네이버 서치어드바이저도 동일)
